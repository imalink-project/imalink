...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_authors_is_self'), 'authors', ['is_self'], unique=False)
    ...
    op.create_index(op.f('ix_users_default_author_id'), 'users', ['default_author_id'], unique=False)
    ...
    op.create_index(op.f('ix_input_channels_default_author_id'), 'input_channels', ['default_author_id'], unique=False)
    op.create_index(op.f('ix_input_channels_id'), 'input_channels', ['id'], unique=False)
    op.create_index(op.f('ix_input_channels_user_id'), 'input_channels', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_input_channels_user_id'), table_name='input_channels')
    ...
    op.drop_index(op.f('ix_users_default_author_id'), table_name='users')
    op.drop_table('users')
    op.drop_index(op.f('ix_authors_name'), table_name='authors')
    op.drop_index(op.f('ix_authors_is_self'), table_name='authors')
