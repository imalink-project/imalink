...
class TestImagesAPI:
    ...
    def test_list_images_returns_paginated_response(self, test_client):
        """GET /api/v1/images/ should return paginated response"""
    ...
    def test_list_images_with_pagination(self, test_client):
        ...
        response = test_client.get("/api/v1/images/?offset=0&limit=50")
    ...
    def test_get_image_not_found(self, test_client):
        ...
        response = test_client.get("/api/v1/images/99999")
    ...
    def test_get_hotpreview_not_found(self, test_client):
        ...
        response = test_client.get("/api/v1/images/99999/hotpreview")
        
        assert response.status_code == 404
    
    def test_create_image_without_data(self, test_client):
        """POST without required data should return 422"""
        response = test_client.post("/api/v1/images/", json={})
...
class TestImagesErrorHandling:
    ...
    def test_invalid_pagination(self, test_client):
        ...
        response = test_client.get("/api/v1/images/?offset=-1&limit=0")
        
        assert response.status_code == 422


class TestImagesArchitecture:
    """Test Image-first architecture principles"""
