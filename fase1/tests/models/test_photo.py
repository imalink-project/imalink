...
Tests photo creation, metadata extraction, and file handling

NOTE: Tests for Photo.create_from_file_group() are SKIPPED because this is a 
deprecated legacy method from the old backend-driven import system. 
In the current architecture, hotpreview is generated by frontend and sent to backend.
"""
import pytest
import tempfile
import shutil
...
@pytest.mark.skip(reason="Legacy method - Photo.create_from_file_group() is deprecated. Hotpreview is now generated by frontend.")
