...
3. Det blir generert en hotpreview, 150x150 pixler. Den blir rotert riktig i henhold til exif_rotation. Fra hotpreview blir det generert en phash. Den regnes som unik og universell nok til å brukes i url-er. Paret hotpreview - hash fungeres som en synlig identifikasjon. Dersom du har thumbnailen kan du genere hashen og finne igjen bilde. Hotpreview er derfor den mest sentrale delen av et bilde. Det er mulig at hotpreview bør få et mer spesifikt navn og ikke forveksles med en miniatyr generert på andre måter.
