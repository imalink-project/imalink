...
class TestImportSessionsAPI:
    ...
    def test_list_import_sessions(self, authenticated_client):
        """GET /api/v1/import-sessions/ should return list"""
        response = authenticated_client.get("/api/v1/import-sessions/", headers=authenticated_client.auth_headers)
    ...
    def test_create_import_session_success(self, authenticated_client):
        """POST /api/v1/import-sessions/ should create session"""
        session_data = {
        ...
        response = authenticated_client.post("/api/v1/import-sessions/", json=session_data, headers=authenticated_client.auth_headers)
    ...
    def test_create_import_session_without_required_fields(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/import-sessions/", json={}, headers=authenticated_client.auth_headers)
    ...
    def test_get_import_session_by_id_not_found(self, authenticated_client):
        ...
        response = authenticated_client.get("/api/v1/import-sessions/99999", headers=authenticated_client.auth_headers)
    ...
    def test_update_import_session_not_found(self, authenticated_client):
        ...
        response = authenticated_client.patch("/api/v1/import-sessions/99999", json=update_data, headers=authenticated_client.auth_headers)
        
        assert response.status_code == 404
    
    def test_delete_import_session_not_found(self, authenticated_client):
        """DELETE with non-existent ID should return 404"""
        response = authenticated_client.delete("/api/v1/import-sessions/99999", headers=authenticated_client.auth_headers)
    ...
    def test_delete_import_session_returns_success_response(self, authenticated_client):
        ...
        create_response = authenticated_client.post("/api/v1/import-sessions/", json=session_data, headers=authenticated_client.auth_headers)
        session_id = create_response.json()["id"]
        
        # Then delete it
        response = authenticated_client.delete(f"/api/v1/import-sessions/{session_id}", headers=authenticated_client.auth_headers)
...
class TestImportSessionsErrorHandling:
    ...
    def test_validation_error_format(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/import-sessions/", json={"default_author_id": "not_an_int"}, headers=authenticated_client.auth_headers)
