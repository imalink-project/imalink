...
class PhotoTextDocumentCreate(BaseModel):
    ...
    visibility: Optional[str] = Field('private', pattern=r'^(private|space|authenticated|public)$', description="Document visibility (optional, defaults to 'private' for backwards compatibility)")
...
class PhotoTextDocumentUpdate(BaseModel):
    ...
    visibility: Optional[str] = Field(None, pattern=r'^(private|space|authenticated|public)$', description="Document visibility (optional, backwards compatible)")
...
class PhotoTextDocumentResponse(BaseModel):
    ...
    visibility: str = Field('private', description="Document visibility: 'private', 'space', 'authenticated', or 'public'")
